...
Date: 12/09/2021
Program: page_73_an_investment_report.py
Problem: An Investment Report.
Solution:
    ...
    3. Computations and outputs: for each year compute the interest and add it to the investment
