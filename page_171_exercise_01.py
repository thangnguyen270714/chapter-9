...
Date: 24/10/2021
Program: page_171_exercise_01.py
Problem: Anne complains that defining functions to use in her programs is a lot of extra
...
Solution:
    - Three reason:
    + Function include basic operator and control statements
    + A function can be called from anywhere in a program’s code, including code
    within other functions
    + There is exist function hide complexly
