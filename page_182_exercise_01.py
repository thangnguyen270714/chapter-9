...
Date: 24/10/2021
Program: page_182_exercise_01.py
Problem: In what way is a recursive design different from top-down design?
Solution:
    ...
    by using the same function. This design strategy is called recursive design, and the resulting
